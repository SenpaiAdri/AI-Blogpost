...
export default function BrutalBlock({
    ...
    return (
        ...
        >
            {/* Label bar */}
            <div
                className={`px-5 sm:px-6 lg:px-8 py-2.5 border-b-2 flex items-center justify-between ${accent ? "border-red-500 border-dashed bg-red-500/10" : "border-[#6A6B70] border-dashed bg-[#1a1a1f]"
                    }`}
            >
                <span className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-[#6A6B70]">
                    [{label}]
                </span>
                <span className="text-[10px] text-[#393A41] font-mono">●</span>
            </div>
